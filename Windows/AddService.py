...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayout.addWidget(self.box_price)
        self.box_deposit = QtWidgets.QLineEdit(parent=self.verticalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.btn_save.setGeometry(QtCore.QRect(150, 230, 121, 51))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Form):
        ...
        self.box_deposit.setPlaceholderText(_translate("Form", "الإيداع"))
